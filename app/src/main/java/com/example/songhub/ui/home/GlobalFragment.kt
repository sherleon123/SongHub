package com.example.songhub.ui.home
...
class GlobalFragment : Fragment(), SongCallback {
    ...
    override fun onCreateView(
        ...
        if( FirebaseAuth.getInstance().currentUser==null) {
            lobby_BTN_signin.text = "Sign In"
            lobby_BTN_addsong.visibility=View.INVISIBLE
        }
        else{
        ...
        loadPublicData { songs ->
            ...
            songAdapter = SongAdapter(songsList).apply {
                songCallback = this@GlobalFragment
            }
